...
export function PredictionDetailSheet({
  ...
  const { data: prediction, isLoading } = useGetData<PredictionDetail>(
    ["predictions", id],
    `/predictions/${id}`,
    {}
  );
  ...
  }, [prediction, isOpen, form]);

  const { mutate: updatePrediction, isPending: isUpdating } = usePatchData<
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="max-w-md overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Prediction Detail</SheetTitle>
          <SheetDescription>
            View and manually correct prediction results
          </SheetDescription>
        </SheetHeader>
            ...
            <>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <Progress
                        value={prediction.probabilityYes * 100}
                        className="h-2"
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Progress
                        value={prediction.probabilityNo * 100}
                        className="h-2"
                      />
                    </div>
                  </div>
              ...
              {permissions.canUpdate && (
                <Card className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/20">
                  ...
                  <CardContent className="text-base">Is this prediction correct?</CardContent>
                  <CardContent>
                    <Form {...form}>
                      <form

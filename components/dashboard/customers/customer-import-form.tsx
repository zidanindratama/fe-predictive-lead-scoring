...
export function CustomerImportForm() {
    ...
    [["customers"]],
    {
      ...
      onError: (error: any) => {
        ...
        if (Array.isArray(responseData?.message)) {
            ...
            details = ["An unexpected error occurred during import. Please check your file format."];
        }
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    if (e.dataTransfer.files && e.dataTransfer.files[0]) {
      ...
      const hasValidExtension = droppedFile.name.endsWith(".csv") || droppedFile.name.endsWith(".xlsx");
          ...
          <div className="md:col-span-1 space-y-6">
             <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Bulk import allows you to add multiple customers efficiently. Please ensure your data follows the required format.
                </p>
             </div>
             ...
             <Alert className="bg-blue-50 text-blue-900 border-blue-200 dark:bg-blue-950/30 dark:text-blue-200 dark:border-blue-900">
                ...
                <AlertDescription className="text-xs mt-2 space-y-1.5">
                  <p>• <strong>Format:</strong> .csv or .xlsx</p>
                  <p>• <strong>Max Size:</strong> 10MB</p>
                  <p>• <strong>Required Columns:</strong> name, age, job, marital, education, default, housing, loan</p>
                </AlertDescription>
             </Alert>
          </div>

          <div className="md:col-span-2 space-y-4">
            <Card className={errorReport ? "border-red-200 dark:border-red-900" : ""}>
              <CardHeader>
            ...
            {errorReport && (
                <Alert variant="destructive" className="animate-in fade-in slide-in-from-top-2 border-red-200 bg-red-50 text-red-900 dark:bg-red-950/20 dark:border-red-900 dark:text-red-200">
                    <XCircle className="h-4 w-4" />
                    <AlertTitle>Import Failed</AlertTitle>
                    <AlertDescription className="mt-3">
                        <p className="mb-2 font-medium text-xs uppercase tracking-wider">Error Details:</p>

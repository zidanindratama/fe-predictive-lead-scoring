...
export function CustomerDetail({ id }: CustomerDetailProps) {
  ...
  const { data: customer, isLoading } = useGetData<Customer>(
    ["customer", id],
    `/customers/${id}`
  );
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium capitalize">
                    {customer.day_of_week}, in {customer.month}
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-xs text-muted-foreground font-medium uppercase">
                  ...
                  <p className="font-medium">
                    {customer.campaign} contacts made
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-xs text-muted-foreground font-medium uppercase">
  ...
  return (
    <div className="p-4 flex items-center justify-between">
      ...
      {isBadge ? (
        <Badge
          variant="outline"
          className="capitalize font-normal bg-white dark:bg-zinc-900"
        >
          {value}
        </Badge>
      ) : (

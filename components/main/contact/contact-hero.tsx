...
export const ContactHero = () => {
  return (
    <section className="relative pt-32 pb-12 md:pt-48 md:pb-24 overflow-hidden bg-background">
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="max-w-4xl">
          ...
          >
            Have questions about our predictive models? Need a custom
            integration? Our team of engineers and financial experts is ready to
            help.
          </motion.p>
        </div>
      </div>

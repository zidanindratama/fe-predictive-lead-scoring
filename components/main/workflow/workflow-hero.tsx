      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-sm font-medium text-foreground mb-8"
          >
            <div className="w-2 h-2 rounded-full bg-green-500 animate-ping" />
            <span>System Architecture Overview</span>
          </motion.div>

          <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter leading-[0.9] mb-8 text-foreground">
            THE{" "}
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            See how SmartBank orchestrates data flow between NestJS, MongoDB,
            and our Predictive ML Engine to deliver real-time insights.
          </p>
        </motion.div>
      </div>
